...
page = requests.get('https://www.yelp.com/search?find_desc=New%20Restaurants&find_loc=Lubbock%2C%20TX')
...
for secondary in secondarys:
    try:
        location = (secondary.find("span").text) + "," + " Lubbock, Texas"
