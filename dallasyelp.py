...
page = requests.get('https://www.yelp.com/search?find_desc=New%20Restaurants&find_loc=dallas')
...
for secondary in secondarys:
    try:
        location = (secondary.find("span").text) + "," + " Dallas, Texas"
